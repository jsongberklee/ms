<?php if (!defined('PATH')) { exit; } ?>
  <div class="container margin-top-container min-height-container" id="mscontainer">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="<?php echo $this->SETTINGS->scriptpath; ?>/?c=<?php echo $this->PARENT['id']; ?>"><?php echo mswCleanData($this->PARENT['name']); ?></a></li>
      <?php
      } else {
      ?>
      <li><a href="<?php echo $this->SETTINGS->scriptpath; ?>/?c=<?php echo $this->PARENT['id']; ?>"><?php echo mswCleanData($this->PARENT['name']); ?></a></li>
        ...
        <div class="row">
          <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 mstabmenuarea">
            <ul class="nav nav-tabs">
              <li class="active"><a href="#one" data-toggle="tab"><i class="fa fa-file-text-o fa-fw"></i> <span class="hidden-sm hidden-xs"><?php echo $this->TXT[5]; ?></span></a></li>
                ...
                <div class="tab-content">
                  ...
                  <div class="tab-pane fade" id="two">
                    ...
                    <div class="form-group">
                      ...
                      ?>
                      <div class="radio">
                        <label><input type="radio" name="c" value="<?php echo $this->PARENT['id']; ?>" checked="checked"> <?php echo str_replace('{cat}', mswSafeDisplay($this->PARENT['name']), $this->TXT[7]); ?></label>
                      </div>
                      <?php
                      }
                      ?>
                      ...
                      <div class="radio">
                        <label><input type="radio" name="c" value="0"<?php echo (!isset($this->PARENT['id']) ? ' checked="checked"' : ''); ?>> <?php echo $this->TXT[6]; ?></label>
                      </div>
