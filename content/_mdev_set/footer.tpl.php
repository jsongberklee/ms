<?php if (!defined('PATH')) { exit; } ?>
    ...
    <?php
	  ...
	  ?>
	  Powered by: <a href="http://www.maiansupport.com" onclick="window.open(this);return false" title="Maian Support">Maian Support</a><br>
    <a href="http://www.maianscriptworld.co.uk" title="Maian Script World" onclick="window.open(this);return false">&copy; 2005 - <?php echo date('Y'); ?> Maian Script World</a>
	  <?php
	  }
	  ?>
		</footer>
