...
<i class="fa fa-angle-right fa-fw"></i> <a href="http://www.maiansupport.com" onclick="window.open(this);return false">Maian Support Website</a><br>
<i class="fa fa-angle-right fa-fw"></i> <a href="http://www.maianscriptworld.co.uk" onclick="window.open(this);return false">MSWorld Website</a><br>
